...
class CreateTable {
    constructor(obj) {
        ...
        this.lastFocusSearch = null; // USE IN FILTER SERACH
    ...
    search(columnName) {
        ...
        (this.currentSeachFunc = () => {
            const searchClass = new Search({ data: data });
            searchClass.search(textSearch, columnName);
            searchClass.combineThis(this);
